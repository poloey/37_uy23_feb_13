...
<div class="container mt-5">
  <div class="p-5 bg-info text-white mb-3 text-center">
    <h2>
    ...
    <?php foreach ($user->posts as $key => $post): ?>
      <tr>
        ...
        <td>
          ...
          <a href="/dashboard/post/edit?id=<?php echo $post->id ?>" class="btn btn-outline-primary"> <i class="fa fa-pencil"></i> Edit</a>
